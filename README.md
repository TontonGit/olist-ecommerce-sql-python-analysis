...
- Do customers return and make repeat purchases?  
...
- The customer base is dominated by low-engagement users  
...
A secure method (`getpass`) is used to input the password at runtime.
